...
<a href="menu.php"><img src="images/frnak_banner_instructions.png" style="border:0;padding-right:0px;" alt="fRNAkenstein" width="600" ></a>
<br><br>
<div id="pointer_div" onclick="point_it(event)" style = "background-image:url('images/flowchart.png');height:528;width:861">
</div>
<br><div class='container'>
<h4>Click on an element for more information.</h4>
