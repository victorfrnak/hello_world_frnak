...
class OneFileLoginApplication
{
    public $subdirectories = "/var/www/subdirectories_for_interface";
    /**
	...
	else if (isset($_GET["action"]) && $_GET["action"] == "daemontoggle") {
		unset($_GET['buyer']);
		$this->doStartSession();
	...
	if($_SESSION['user_name'] == 'fRNAkadmin' || $_SESSION['user_name'] == 'toast')
	{
		...
		echo '<a href="/log_view.php">View logs</a><br><br>';
		...
		echo '<a href="status.php">View Status </a> <br>(no return to ctrl panel except browser back button)<br><br>';
		echo '<a href="menu.php">To fRNAkenstein </a> <br>(no return to ctrl panel except browser back button)<br><br>';
