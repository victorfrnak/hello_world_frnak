...
///comment this out for now because we are currently relying on PhP thought this may, of course
///change

//function query_datastore(search_term)
//{
//  var token = <?php echo(json_encode($token)); ?>;
 // var user = <?php echo(json_encode($user)); ?>;
  ...
  //var url = "-sk -H \"Authorization: Bearer" + token + "\" https://agave.iplantc.org:443/files/v2/listings/schmidtc/Transcriptome_Delaware";
  
  //$.getJSON(url, function(data)
 // {
  //  alert(data.results);
  //  alert("is the data results !! ");
  //});
...
{
	echo '<div>';
	echo '<form id="submitform" onsubmit="return valthisform(this);" action="mapcount_response_changed_IV.php" method="post" target="formresponse">';
...
//echo count($filesFromDataStore) . " is the length of the files from data store II !! \n \n";
...
if(count($fqfiles)<3){ #because of . and .. directories existing
	...
	{
		//echo $fqfile . " is one of the fastq files !!! \n \n";
