...
if(empty($_POST['analysis'])){
	...
	echo '</center>';
	echo '<br>';
	echo '<form method="POST" action="data_level_results_newAug11.php"';	
...
if($isDiffExpress == 1)
{
	...
	$files = array("genes_sig_in_at_least_0.txt", "genes_sig_in_at_least_1.txt", "genes_sig_in_at_least_2.txt", "genes_sig_in_at_least_3.txt", "genes_sig_in_at_least_4.txt");
	...
	$cuffDiffFiles = array("bias_params.info", "cds.fpkm_tracking", "genes.count_tracking", "isoforms.count_tracking", "read_groups.info",  "tss_groups.count_tracking", "cds.count_tracking",  "cds.read_group_tracking",  "genes.fpkm_tracking", "isoforms.fpkm_tracking",  "run.info","tss_groups.fpkm_tracking","cds.diff","cuffData.db","genes.read_group_tracking","isoforms.read_group_tracking","splicing.diff","tss_groups.read_group_tracking","cds_exp.diff","gene_exp.diff","isoform_exp.diff" , "promoters.diff" , "tss_group_exp.diff" ,"var_model.info");
...
?>
<form class="go-bottom" id='submitform' action='data_level_results_response_july3rd.php' method='post' target='formresponse'>
...
if($isDiffExpress != 1)
{
	...
	echo "<form class=\"go-bottom\" id=\"submitform\" action=\"data_level_results_response_july3rd.php\" method=\"post\" target=\"formresponse\">";
...
$pathToFiles = $user . "/mapcount_output/" . $analysis . "/cufflinks_out/" . $file;


 if($isDiffExpress != 1)
{
	echo $library . "is the library !!!";
	$files = array("genes.fpkm_tracking","isoforms.fpkm_tracking","transcripts.gtf",  "skipped.gtf", "$library.counts","log.txt");
	...
	{	
		if($isDiffExpress != 1)
		{
			...
			if($file == "genes.fpkm_tracking")
			{
				...
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \" genes.fpkm_tracking\" class=\"green\" style=\"font-weight:bold\" name=\"help0\">" . "<span><span class=\"helper\" id=\"help1\"><b>		</b></span><br><br>";;
				echo "</div>";
				echo "</td>";
			}
			else if($file == "isoforms.fpkm_tracking")
			{
				...
				echo "<td>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"isoforms.fpkm_tracking\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help2\"><b>		</b></span><br><br>";
				echo "</div>";
				echo "</td>";
				echo "</tr>";
			}
			else if($file == "transcripts.gtf")
			{
				...
				echo "<td>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"transcripts.gtf\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help4\"><b>		</b></span><br><br>";
				echo "</div>";
				echo "</td>";
			}
			else if($file == "skipped.gtf")
			{
				...
				echo "<td>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"skipped.gtf\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help3\"><b>		</b></span><br><br>";;
				echo "</div>";
				echo "</td>";
			}
			...
			else if($file == "$library.counts")
			{
				...
				//echo "<center>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToRawCount&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"HTseq Count\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help3\"><b>		</b></span><br><br>";;
				echo "</div>";
				echo "</td>";
			} 
			...
			else if($file == "log.txt")
			{
				...
				echo "<center>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToUserLog&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"MapCount Log Commands\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help3\"><b>		</b></span><br><br>";;
				echo "</div>";
				echo "</td>";
				echo "</table>";
			} 
		...
		if($isDiffExpress == 1)
		{
			...
			if(preg_match($pattern, $file, $matches) == 1)
			{
				...
				$pathToFiles = $user . "/diffexpress_output/$analysis";
				...
				if($geneSigNumber == 0)
				{
					...
					echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"All genes\"class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help15\" style=\"color:blue;\"><b>		</b></span><br><br>";	
				}
				else
				{
					$nameOfFiles = $analysis . "$geneSigNumber";
					echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"Genes sig in at least $geneSigNumber\"class=\"green\" style=\"font-weight:bold\" >";
				}
				echo "</div>";
				echo "</td>";
				if($geneSigNumber == 2)
			...
			if($file == "$log.txt")
			{
				...
				echo "<center>";
				echo "<div id=\"button-container\">";
				echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToUserLog&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"Log For Diffexpress\" style=\"font-weight:bold\" class=\"green\">" . "<span><span class=\"helper\" id=\"help3\"><b>		</b></span><br><br>";;
				echo "</div>";
			}
...
foreach($cuffDiffFiles as $file)
{
	if(($file != "..") & ($file != "."))
	{
		...
		if($file == "cds.fpkm_tracking")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"cds.fpkm_tracking\" class=\"green\" style=\"font-weight:bold\">" . "<span><span class=\"helper\" id=\"help5\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
			echo "</tr>";
		}
		if($file == "cds_exp.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"cds_exp.diff\" class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help6\" style=\"color:blue;\"><b>		</b></span><br><br>";
			echo "</div>";
			echo "</td>";
		}
		if($file == "gene_exp.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"gene_exp.diff\" class=\"green\" style=\"font-weight:bold\">" . "<span><span class=\"helper\" id=\"help7\"><b>			</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
		...
		if($file == "genes.fpkm_tracking")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"genes.fpkm_tracking\" class=\"green\" style=\"font-weight:bold\">" . "<span><span class=\"helper\" id=\"help8\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
			echo "</tr>";
		}
		if($file == "isoform_exp.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"isoform_exp.diff\" class=\"green\" style=\"font-weight:bold\">" . "<span><span class=\"helper\" id=\"help9\"><b>			</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
		}
		if($file == "isoforms.fpkm_tracking")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"isoforms.fpkm_tracking\" class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help10\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
		}
		if($file == "promoters.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"promoters.diff\" class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help11\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
			echo "</tr>";
		}
		if($file == "splicing.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"splicing.diff\" class=\"green\" style=\"font-weight:bold\">" . "<span><span class=\"helper\" id=\"help12\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
		}
		if($file == "tss_group_exp.diff")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"tss_group_exp.diff\" class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help13\"><b>		</b></span><br><br>";
			echo "</div>";
			echo "</td>";
		}
		if($file == "tss_groups.fpkm_tracking")
		{
			...
			echo "<td>";
			echo "<div id=\"button-container\">";
			echo "<a href=\"data_level_results_response_july3rd.php?fetchResults=$pathToFiles&analysis=$nameOfFiles\" download> <input type =\"button\" id=\"button\" value = \"tss_groups.fpkm_tracking\" class=\"green\" style=\"font-weight:bold\" >" . "<span><span class=\"helper\" id=\"help14\"><b>		</b></span><br><br>";;
			echo "</div>";
			echo "</td>";
			echo "</tr>";
		}	
...
<div class='container'>
<center>
<form action = 'data_level_results_response_july3rd.php' target = 'formresponse'>
